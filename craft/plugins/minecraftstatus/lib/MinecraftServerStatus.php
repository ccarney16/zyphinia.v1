...
require dirname(__DIR__).'/lib/Packets/Packet.php';
require dirname(__DIR__).'/lib/Packets/HandshakePacket.php';
require dirname(__DIR__).'/lib/Packets/PingPacket.php';
